...
import Controlador.ControladorAltaCalifUnidad;
 ...
 * @author Usuario
 */
public class DocenteEditarMat extends javax.swing.JFrame {

    /**
     * Creates new form DocenteAltaAct
     */
    public DocenteEditarMat() {
        initComponents();
        llenarMaterias();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Editar Materia");
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 30, 130, -1));
        ...
        jPanel2.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 50, 142, 36));
        ...
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 142, -1));

        jLabel9.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("Materia");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 140, 150, -1));

        jLabel12.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 0, 0));
        jLabel12.setText("Nombre de la Materia");
        jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 140, 150, -1));
        ...
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 160, 250, -1));
        ...
        jPanel2.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 240, 142, -1));

        jLabel13.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(0, 0, 0));
        jLabel13.setText("Horas prácticas");
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 220, 150, -1));

        jLabel14.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(0, 0, 0));
        jLabel14.setText("Horas teóricas");
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 220, 150, -1));
        ...
        jPanel2.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 240, 142, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        CAM.modificarMateria(this, jComboBox2, jTextField1, jTextField2, jTextField3, jTextField4);
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        // TODO add your handling code here:
        String idMateria = jComboBox2.getSelectedItem().toString();

        // Realizar la búsqueda en la base de datos con el número de control seleccionado
        Conexion con = new Conexion();
        String consultaAlumno = "SELECT idMat, nombMat, hTeoMat, hPraMat FROM Materia WHERE idMat = ?";

        try {
            PreparedStatement psAlumno = con.conecta().prepareStatement(consultaAlumno);
            psAlumno.setString(1, idMateria);
            ...
            if (rsAlumno.next()) {
                ...
                String nombMat = rsAlumno.getString("nombMat");
                int hTeoMat = rsAlumno.getInt("hTeoMat");
                int hPraMat = rsAlumno.getInt("hPraMat");

                // Insertar los valores en los JTextFields correspondientes
                jTextField1.setText(idMat);
                jTextField2.setText(nombMat);
                jTextField3.setText(String.valueOf(hTeoMat));
                jTextField4.setText(String.valueOf(hPraMat));
            } else {
