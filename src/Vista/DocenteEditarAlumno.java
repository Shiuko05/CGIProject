 ...
 * @author Usuario
 */
public class DocenteEditarAlumno extends javax.swing.JFrame {

    /**
     * Creates new form DocenteAltaAlumno
     */
    public DocenteEditarAlumno() {
        initComponents();
        llenarAlumnos();
    }
...
//    private void llenarAlumno(String alumno){
//        // Realizar la búsqueda en la base de datos con el número de control seleccionado
//        Conexion con = new Conexion();
//        String consultaActividad = "SELECT nombAlum, apePatAlum, apeMatAlum, semestreAlum, fechaNacAlum, curpAlum, nControlAlum, correoAlum FROM Alumno WHERE nControlAlum = ?";
//
//        try {
//            PreparedStatement psAlumno = con.conecta().prepareStatement(consultaActividad);
//            psAlumno.setString(1, alumno);
//            ResultSet rsAlumno = psAlumno.executeQuery();
//
//            if (rsAlumno.next()) {
//                // Si se encuentra el alumno, obtener su nombre, apellido paterno y apellido materno
//                String nombAlum = rsAlumno.getString("nombAlum");
//                String apePatAlum = rsAlumno.getString("apePatAlum");
//                String apeMatAlum = rsAlumno.getString("apeMatAlum");
//                int semestreAlum = rsAlumno.getInt("semestreAlum");
//                String fechaNacAlum = rsAlumno.getString("fechaNacAlum");
//                String curpAlum = rsAlumno.getString("curpAlum");
//                String nControlAlum = rsAlumno.getString("nControlAlum");
//                String correoAlum = rsAlumno.getString("correoAlum");
//                
//
//                // Insertar los valores en los JTextFields correspondientes
//                jTextField1.setText(nombAlum);
//                jTextField2.setText(apePatAlum);
//                jTextField3.setText(apeMatAlum);
//                jTextField6.setText(String.valueOf(semestreAlum));
//                jTextField7.setText(fechaNacAlum);
//                jTextField4.setText(curpAlum);
//                jTextField5.setText(nControlAlum);
//                jTextField8.setText(correoAlum);
//            } else {
...
//    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, -1, -1));
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 400, 125, 32));
        ...
        jPanel2.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 260, -1, -1));
        ...
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, -1, -1));
        ...
        jPanel2.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, -1, -1));
        ...
        jPanel2.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, 120, -1));

        jLabel9.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("Semestre");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 80, -1, -1));

        jLabel10.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("Fecha de Nacimiento");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 160, -1, -1));
        ...
        jPanel2.add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, 120, -1));

        jLabel11.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 0, 0));
        jLabel11.setText("Correo");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 240, -1, -1));
        ...
        jPanel2.add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 260, 270, -1));
        ...
        jPanel2.add(jComboBox4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 30, 142, 36));

        jLabel12.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 0, 0));
        jLabel12.setText("No. Control");
        jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 80, -1, -1));
        ...
        jPanel2.add(jTextField9, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 100, 120, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        caa.modificarAlumno(this, jTextField1, jTextField2, jTextField3, jTextField4, jComboBox4, jTextField6, jTextField7, jTextField8, jTextField9);
    ...
    private void jComboBox4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox4ActionPerformed
        // TODO add your handling code here:
        String numeroControlSeleccionado = jComboBox4.getSelectedItem().toString();

        // Realizar la búsqueda en la base de datos con el número de control seleccionado
        Conexion con = new Conexion();
        String consultaAlumno = "SELECT nombAlum, apePatAlum, apeMatAlum, semestreAlum, fechaNacAlum, curpAlum, nControlAlum, correoAlum FROM Alumno WHERE nControlAlum = ?";
        ...
        try {
            ...
            if (rsAlumno.next()) {
                ...
                jTextField4.setText(curpAlum);
                jTextField8.setText(correoAlum);
                jTextField9.setText(nControlAlum);
            } else {
                // Si no se encuentra el alumno, limpiar los JTextFields
                jTextField1.setText("");
                jTextField2.setText("");
